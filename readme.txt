...
Contributors: errnio
Tags: mobile, search, mobile search, search in site, better search, better site search, advertising, ad units, pay per click, PPC, monetise, monetize, gesture, advertizing, banners, make money, site search, web search, mobile friendly, mobile optimization
...
* **Revenue Program** - registered sites can take advantage of our revenue program once signed up and confirmed. Please contact us directly for more details.
...
2.1 New design for errnio settings page and admin notice
...
2.4 Added handling of multiple installed errnio plugins

2.5 Simplified code on wp client side

2.6 Added script versioning and parameters validation
